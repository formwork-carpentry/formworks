...
import type { CompiledQuery, IDatabaseAdapter, QueryResult } from "../contracts";
...
export class PostgresAdapterStub extends UnsupportedDriverAdapter {
  constructor() {
    super(
      "postgres",
      "PostgreSQL driver is not installed. Run: npm install pg",
      "PostgreSQL adapter is unavailable.",
    );
  }
}
...
export class MySQLAdapterStub extends UnsupportedDriverAdapter {
  constructor() {
    super(
      "mysql",
      "MySQL driver is not installed. Run: npm install mysql2",
      "MySQL adapter is unavailable.",
    );
  }
}
...
export class MongoDBAdapterStub extends UnsupportedDriverAdapter {
  constructor() {
    super(
      "mongodb",
      "MongoDB driver is not installed. Run: npm install mongodb",
      "MongoDB adapter is unavailable.",
    );
  }
}
