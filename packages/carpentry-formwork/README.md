...
The Carpenter Framework — batteries-included TypeScript backend framework. Install once, import everything.
...
```bash
npm install @carpentry/formwork
```

## Quick Start

```ts
import * as carpentryformwork from '@carpentry/formwork';
