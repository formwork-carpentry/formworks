...
export function Link(props: LinkProps): { tag: "a"; props: LinkProps } {
  ...
  return { tag: "a", props: { ...props, href: link.href, method: link.method } };
}

export function createLineChart(dataset: ChartDataset): {
  type: "line";
  dataset: ChartDataset;
} {
  return { type: "line", dataset };
}

export function createBarChart(dataset: ChartDataset): {
  type: "bar";
  dataset: ChartDataset;
} {
  return { type: "bar", dataset };
}
